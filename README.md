...
![Tests](https://img.shields.io/badge/TESTS-11%20PASS%20/%201%20FAIL-brightgreen?style=for-the-badge)
...
|:---|:---|:---:|:---|:---:|
| **TC-001** | Creación exitosa de playlist | PE-Válida | Playlist creada. URL actualiza a `/playlist/...`. | ✅ PASS |
